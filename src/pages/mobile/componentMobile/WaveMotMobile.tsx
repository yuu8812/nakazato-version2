    ...
    <Box paddingTop={40} overflow={'hidden'} minH={'2000px'}>
      ...
      >
        <Center paddingTop={40} flexDir={'column'}>
          <img src={mot1} alt="mot" loading="lazy" width={300} height={200} />
          <Text mt={8}>もうちょっとマシな世界を生きたいし、</Text>
          <Text>もうちょいマシな物語を作ることに貢献したい</Text>
        </Center>
        <Center paddingTop={8} flexDir={'column'}>
          <img src={mot2} alt="mot" loading="lazy" width={300} height={200} />
        ...
        <Center paddingTop={8} flexDir={'column'}>
          <img src={mot3} alt="mot" loading="lazy" width={300} height={200} />
        ...
        <Center paddingTop={8} flexDir={'column'}>
          <img src={mot4} alt="mot" loading="lazy" width={300} height={200} />
